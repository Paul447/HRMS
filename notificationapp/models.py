...
class Notification(models.Model):
    ...
    actor = models.ForeignKey(
        settings.AUTH_USER_MODEL, # References the User model defined in settings.AUTH_USER_MODEL
        on_delete=models.SET_NULL, # If the actor user is deleted, this field becomes NULL
        null=True,
        blank=True,
        related_name='initiated_notifications', # How to access notifications where this user is the actor
    ...
    recipient = models.ForeignKey(
        ...
        on_delete=models.CASCADE, # If the recipient user is deleted, delete their notifications
        related_name='notifications', # How to access notifications received by this user (user.notifications.all())
    ...
    content_type = models.ForeignKey(
        ContentType, # References Django's ContentType model (tracks all models in your project)
    ...
    timestamp = models.DateTimeField(
        auto_now_add=True, # Automatically sets the timestamp on creation
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["recipient", "read", "-timestamp"]), # Optimize for fetching unread/all notifications for a user
            models.Index(fields=["content_type", "object_id"]),     # Optimize for GenericForeignKey lookups
        ]
