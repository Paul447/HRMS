...
class SickLeaveProratedValue(models.Model):
    ...
    fte_value = models.DecimalField(
        max_digits=3, decimal_places=2,  help_text="FTE value: 1.0 for Full-Time, >0.5 for Part-Time (per SEMO policy).",
    ...
    prorated_unverified_sick_leave = models.DecimalField(
        max_digits=5, decimal_places=2, help_text="Base unverified sick leave 64 hrs. Automatically Prorated by FTE. Don't Modify unless the policy changes maximum value.",
    ...
    prorated_upfront_verified = models.DecimalField(
        max_digits=5, decimal_places=2, help_text="Base upfront verified sick leave 96 hrs. Automatically Prorated by FTE. Don't Modify unless the policy changes upfront verified sick leave value.",
        null=True, blank=True
    )
    class Meta:
...
class MaxSickValue(models.Model):
    ...
    """
    max_unverified_sick_leave = models.DecimalField(
        max_digits=5, decimal_places=2, default=64.0, help_text="Base unverified sick leave 64 hrs. Automatically Prorated by FTE. Don't Modify unless the policy changes maximum value."
    )
    upfront_verified = models.DecimalField(
        max_digits=5, decimal_places=2, default=96.0, help_text="Base upfront verified sick leave 96 hrs. Automatically Prorated by FTE. Don't Modify unless the policy changes upfront verified sick leave value."
    )
    accrued_rate = models.DecimalField(
        max_digits=11, decimal_places=10,
