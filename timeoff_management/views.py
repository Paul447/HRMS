...
class IsManagerOfDepartment(permissions.BasePermission):
    """
    Custom permission to allow only department managers or superusers to access data.
    """
    ...
    def has_permission(self, request, view):
        ...
        return getattr(getattr(user, "userprofile", None), "is_manager", False)
    ...
    def has_object_permission(self, request, view, obj):
        ...
        obj_profile = getattr(obj.user, "userprofile", None)
        return (
            user_profile
            and obj_profile
            and user_profile.is_manager
            and user_profile.department == obj_profile.department
        )
