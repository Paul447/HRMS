    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_holiday', models.BooleanField(default=False, help_text='Indicates if this clock entry is for a holiday. Used for special handling.', verbose_name='Is Holiday')),
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='The date and time when this clock entry was created.', verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='The date and time when this clock entry was last updated.', verbose_name='Updated At')),
