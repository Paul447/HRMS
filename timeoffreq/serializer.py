...
class TimeoffRequestSerializer(serializers.ModelSerializer):
    ...
    approved_by_full_name = serializers.CharField(source='approved_by.get_full_name', read_only=True)
    rejected_by_full_name = serializers.CharField(source='rejected_by.get_full_name', read_only=True)
...
class TimeoffRequestSerializerEmployee(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = [
            'employee', 'status', 'time_off_duration'
        ]
