import { fetchPTORequests, deletePTORequest, fetchApprovedAndRejectedRequests, fetchPAYPeriods } from './modules/timeoffview/apiService.js';
import { showToast, toggleLoading, toggleNoRequestsMessage, toggleErrorMessage, checkURLForMessages } from './modules/timeoffview/uiHelpers.js';
import { renderRequests } from './modules/timeoffview/tableRenderer.js';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleUpdateClick(id) {
        window.location.href = `/auth/timeoffreq/?id=${id}`;
    }
